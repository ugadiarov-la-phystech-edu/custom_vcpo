...
# Vanilla fully-async GRPO on the fork's pipeline: identical to
# vcpo_k=2_8gpu_dapo17k_4+4.sh but with all VCPO mechanisms off
# (update_policy_per_traj / ess_scaling / grad_baselining disabled), so the
# pair is a clean VCPO-on/off ablation.
