...
total_rollout_steps=$((${smoke_steps:-3} * num_minibatches_per_update * updates_per_param_sync * train_prompt_mini_bsz))
epochs=10000000
test_freq=${test_freq:-1}
save_freq=-1

# ================= Logging =================
exp_name="VCPO k-${staleness_threshold} SMOKE-DAPO17K Qwen3-1.7B ${n_gpus_rollout}-${n_gpus_training} B-${train_prompt_mini_bsz} ${loss_agg_mode} ${max_response_length}-len ${weight_decay}-wd"
