#!/usr/bin/env bash
# Colocated synchronous baseline via verl.trainer.main_ppo (hybrid engine, 6
# GPUs) — counterpart of synchronous_6gpu_math_3+3.sh with identical
# model/data/algorithm/optimizer numerics and global batch; differences are
# only those forced by the colocated architecture.
...
# generation batch, matching the async pipeline; global batch identical (33 x
# 16 = 528 seqs, divisible by DP=6).
train_prompt_bsz=33
