...
# rebalanced to 5 rollout + 3 trainer GPUs, Megatron backend. Trainer
# tp=1/dp=3 (sequence_parallel needs TP>1), fixed micro-batching, mini-batch
# 129 (divides by DP=3). Optimizer fully offloaded to CPU
# (HybridDeviceOptimizer, exact fp32 updates) — GPU-resident would need ~66 GB
# static, too little headroom for tp=1 full-vocab transients. Do NOT use
