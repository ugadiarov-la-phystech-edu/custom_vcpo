...
train_prompt_bsz=0
gen_prompt_bsz=1
train_prompt_mini_bsz=128 # divisible by trainer dp=2
micro_bsz_per_gpu=1
...
# ================= Logging =================
exp_name=${exp_name:-"GRPO-noVCPO k-${staleness_threshold} DAPO17K-AIME24 Qwen3-4B ${n_gpus_rollout}-${n_gpus_training} tp1dp2 B-${train_prompt_mini_bsz} ${loss_agg_mode} ${max_response_length}-len ${weight_decay}-wd"}
