...
# grpo_novcpo_k=1_8gpu_dapo17k_5+3_resp8k_megatron_offload_ppo-epochs=2_B33x1_decoupled.sh
#
...
#   pi_rollout  the vLLM bf16 generator, up to k=1 param versions stale
