...
# Vanilla fully-async GRPO: variant of grpo_novcpo_k=1_8gpu_dapo17k_4+4.sh
# with staleness_threshold=2 (matching the VCPO baseline's gating) and
# max_response_length reduced to 8192. VCPO mechanisms off.
