...
#SBATCH --job-name=grpo-novcpo-replay-anchor-mu-lrscale1
...
clip_ratio=0.2
# Arm A clip band (see header): asymmetric DAPO clip-higher band around the
# mu-anchored ratio; clip_ratio_c is the dual-clip guard for the A<0, r>>1
# corner (keep at 3.0 — the cppo arms' 20.0 repurposes it as a TIS cap and
