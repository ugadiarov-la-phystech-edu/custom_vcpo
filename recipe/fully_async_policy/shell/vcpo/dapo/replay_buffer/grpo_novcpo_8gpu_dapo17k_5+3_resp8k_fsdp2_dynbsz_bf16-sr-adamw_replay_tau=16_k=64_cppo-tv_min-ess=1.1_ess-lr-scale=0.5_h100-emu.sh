...
# H100-EMULATION variant of the CPPO arm, for remote_h200 (8 x H200, 143771 MiB
# each). Constrains both GPU pools to an 80 GiB budget so the run's memory
# envelope is representative of an 8 x H100 machine.
#
...
cppo_tag="cppo-tv-d${cppo_delta:-0.15}-db${cppo_delta_b:-0.02}-${cppo_w_len_mode:-sequence}"
use_kl_loss=False
kl_loss_coef=0.0
