...
class DetachActorWorker(DetachNcclSync):
    def __init__(self, *args, **kwargs):
        ...
        # peak (bf16 FSDP2 + dynamic bsz OOMed on fragmentation, not
        # capacity). Must NOT be set via the launch env: vLLM's sleep-mode
        # allocator asserts against it and env vars reach the rollout
        # processes.
