...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto):
        ...
        # Deferred old-log-prob path (mirrors megatron_actor.update_policy):
        # the batch arrives without old_log_probs/IS weights; this actor
        # anchors the ratio on its own forward pass and computes the
        # correction per micro-batch.
