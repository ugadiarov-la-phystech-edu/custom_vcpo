...
class TestOpenPanguAnswerExtraction(unittest.TestCase):
    ...
    def test_both_validation_data_sources_dispatch(self):
        ...
        On this branch the dispatch is math_dapo plus any data_source starting with "aime"
        (reward_score/__init__.py), so both reach the same scorer.
        """
        for data_source in ("math_dapo", "aime2025_dapo", "aime2024"):
